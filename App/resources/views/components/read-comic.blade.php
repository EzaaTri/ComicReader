    ...
    <div id="content" class="readercontent">
        <div class="wrapper">
            <div class="chapterbody">
                <div class="postarea">
                    <article id="post-518594" class="post-518594 hentry" itemscope="itemscope" itemtype="http://schema.org/CreativeWork">
                        <div class="headpost">
                            <h1 class="entry-title" itemprop="name">Omniscient Reader’s Viewpoint Chapter 210 Bahasa Indonesia</h1>
                            <div class="allc">Semua chapter ada di <a href="https://kiryuu.id/manga/omniscient-readers-viewpoint/">Omniscient Reader’s Viewpoint</a></div>
                        </div>
                        <div class="entry-content entry-content-single maincontent" itemprop="description">
                            <div class="chdesc">
                                <p>
                                    Baca manga <b>Omniscient Reader’s Viewpoint Chapter 210</b> bahasa Indonesia terbaru di <b>Kiryuu ID</b>. Manga <b>Omniscient Reader’s Viewpoint</b> bahasa Indonesia selalu update di <b>Kiryuu ID</b>. Jangan lupa membaca update manga lainnya ya. Daftar koleksi manga <b>Kiryuu ID</b> ada di menu Daftar Manga.
                                </p>
                            </div>
                            <div class="chnav ctop nomirror">
                                <span class="selector slc l">
                                    <div class="nvx">
                                        <select name="chapter" id="chapter">
                                            ...
                                            <option data-id="521778" value="https://kiryuu.id/omniscient-readers-viewpoint-chapter-213/">Chapter 213</option>
                                            <option data-id="154105" value="https://kiryuu.id/omniscient-readers-viewpoint-chapter-0/">Chapter 0</option>
                                        </select>
                                    </div>
                                </span>
                                ...
                                <span class="navlef">
                                    <span class="npv r">
                                        <div class="nextprev">
                                            <a class="ch-prev-btn" href="https://kiryuu.id/omniscient-readers-viewpoint-chapter-209/" rel="prev">
                                                <i class="fas fa-angle-left"></i> Prev
                                            </a>
                                            <a class="ch-next-btn" href="https://kiryuu.id/omniscient-readers-viewpoint-chapter-211/" rel="next">
                                    ...
                                    <span class="amob">
                                        <span class="selector pagedsel r">
                                            <select name="select-paged" class="ts-select-paged" id="select-paged" aria-label="select page">
                                                ...
                                                <option value="1">2/13</option>
                                                <option value="2">3/13</option>
                                                <option value="3">4/13</option>
                                                <option value="4">5/13</option>
                                                <option value="5">6/13</option>
                                                <option value="6">7/13</option>
                                                <option value="7">8/13</option>
                                                <option value="8">9/13</option>
                                    ...
                                    <span class="dlx r"></span>
                                </span>
                            </div>
                            <div id="readerarea">
                                <img class="ts-main-image curdown" data-index="0" src="/img/solev.png" data-server="Server1" onload="ts_reader_control.singleImageOnload();" onerror="ts_reader_control.imageOnError();" alt="Omniscient Reader’s Viewpoint Chapter 210 page 0">
                            </div>
                            <div class="kln">
                                <a href="https://kiryuu.id/join-us/"><img src="/img/solev.png" alt="" width="1084" height="1354" class="aligncenter size-full wp-image-312538"></a>
                                <br>
                            </div>
                            <div class="chnav ctop nomirror" style="margin-top: 15px;">
                                <span class="selector slc l">
                                    <div class="nvx">
                                        <select name="chapter" id="chapter">
                                            <option value="" disabled="disabled">Pilih Chapter</option>
                    ...
                    <div id="comments" class="bixbox comments-area"></div>
                </div>
            </div>
        </div>
    </div>
