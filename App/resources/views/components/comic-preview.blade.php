<body class="darkmode" itemscope itemtype="http://schema.org/WebPage" style="position: relative;">
    <div class="mainholder">
        <div id="content" class="manga-info mangatere">
            <div class="wrapper">
                <div class="bigcover">
                    <div class="bigbanner img-blur" style="background-image: url('/img/solev.png');"></div>
                </div>
                <div class="terebody">
                    <div class="postbody seriestu seriestere">
                        <article id="post-368923" class="post-368923 hentry" itemscope itemtype="http://schema.org/CreativeWorkSeries">
                            <div class="seriestucon">
                                <div class="seriestuheader">
                                    <h1 class="entry-title" itemprop="name">To Hell With Being A Saint, I’m A Doctor Bahasa Indonesia</h1>
                                </div>
                                <div class="seriestucontent">
                                    <div class="seriestucontl">
                                        <div class="thumb" itemprop="image" itemscope itemtype="https://schema.org/ImageObject">
                                            <img width="720" height="1030" src="/img/solev.png" class="attachment- size- wp-post-image" alt="To Hell With Being A Saint, I’m A Doctor" title="To Hell With Being A Saint, I’m A Doctor" itemprop="image" decoding="async" fetchpriority="high">
                                        </div>
                                        <div data-id="368923" class="bookmark"><i class="far fa-bookmark" aria-hidden="true"></i> Bookmark</div>
                                    </div>
                                    <div class="seriestucontentr">
                                        <div class="seriestuhead">
                                            <div class="entry-content entry-content-single" itemprop="description">
                                                <p>Yusung adalah seorang dokter jenius yang terkenal di dunia medis. Dia, yang menghabiskan seluruh hidupnya di ruang operasi, meninggal dalam kecelakaan lalu lintas, dan ketika dia bangun, dia berada di dunia lain. Tapi… orang suci? Sebuah kerajaan suci? Sihir penyembuhan? “Saya berusaha keras untuk belajar kedokteran, tetapi sekarang yang perlu saya lakukan hanyalah menyentuh seseorang dan mereka sembuh? Serius, saya pikir saya sudah gila. ”</p>
                                            </div>
                                            <div class="lastend">
                                                <div class="inepcx">
                                                    <a href="https://kiryuu.id/to-hell-with-being-a-saint-im-a-doctor-chapter-1/">
                                                        <span>Awal:</span>
                                                        <span class="epcur epcurfirst">Chapter 1</span>
                                                    </a>
                                                </div>
                                                <div class="inepcx">
                                                    <a href="https://kiryuu.id/to-hell-with-being-a-saint-im-a-doctor-chapter-83/">
                                                        <span>Terbaru:</span>
                                                        <span class="epcur epcurlast">Chapter 83</span>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <table class="infotable">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>Posted On</td>
                                                            <td>
                                                                <time itemprop="datePublished" datetime="2022-05-31T23:17:32+07:00">Mei 31, 2022</time>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Updated On</td>
                                                            <td>
                                                                <time itemprop="dateModified" datetime="2024-06-05T10:30:49+07:00">Juni 5, 2024</time>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Views</td>
                                                            <td>
                                                                <span class="ts-views-count">1.7M</span>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <div class="seriestugenre">
                                                    <a href="https://kiryuu.id/genres/adventure/" rel="tag">Adventure</a>
                                                    <a href="https://kiryuu.id/genres/fantasy/" rel="tag">Fantasy</a>
                                                    <a href="https://kiryuu.id/genres/isekai/" rel="tag">Isekai</a>
                                                    <a href="https://kiryuu.id/genres/reincarnation/" rel="tag">Reincarnation</a>
                                                    <a href="https://kiryuu.id/genres/shounen/" rel="tag">Shounen</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
